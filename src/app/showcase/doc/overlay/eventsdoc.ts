...
export class EventsDoc {
    ...
    code: Code = {
        typescript: `
import { PrimeNGConfig, OverlayOptions, OverlayOnBeforeShowEvent, OverlayOnShowEvent, OverlayOnBeforeHideEvent, OverlayOnHideEvent } from '@coduction/primeng/api';
