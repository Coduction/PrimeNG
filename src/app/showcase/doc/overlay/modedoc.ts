...
export class ModeDoc {
    ...
    code: Code = {
        typescript: `
import { PrimeNGConfig, OverlayOptions } from '@coduction/primeng/api';
...
export class AppComponent implements OnInit {
    ...
    code2: Code = {
        basic: `
import { PrimeNGConfig, OverlayOptions, ResponsiveOverlayDirectionType } from '@coduction/primeng/api';
